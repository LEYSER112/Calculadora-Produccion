export const State = {
    ...
    urlGuardarProduccion: 'https://script.google.com/macros/s/AKfycbw1K3GgoPDXaVjBHJDs1T1Pu0-pa_ehlVD18OcqOjqcahL4drwnB9cyecuipt6-S2eI/exec',
    ordenColumnasSheet: [
        "Fecha","Turno","Producto","Lote","Cantidad producida","Cliente","Descripción","Mes","Año",
...
// Trae el listado de clientes desde la pestaña "Clientes" del mismo
// Sheets de producción, vía el Apps Script (petición GET con ?accion=clientes).
// Así, para agregar/quitar clientes solo se edita esa hoja, sin tocar código.
